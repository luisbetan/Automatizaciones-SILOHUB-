...
class cuenta_ctacte_histApagar(unittest.TestCase):
    def setUp(self):
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(cuenta_ctacte_histApagar)
  runner = xmlrunner.XMLTestRunner(output='reportCtacteHistApagar')
