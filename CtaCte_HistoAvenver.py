...
class cuenta_ctacte_histAvencer(unittest.TestCase):
    def setUp(self):
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(cuenta_ctacte_histAvencer)
  runner = xmlrunner.XMLTestRunner(output='reportCtacteHistAvencer')
