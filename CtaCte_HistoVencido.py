...
class cuenta_ctacte_histVencido(unittest.TestCase):
    def setUp(self):
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(cuenta_ctacte_histVencido)
  runner = xmlrunner.XMLTestRunner(output='reportCtacteHistVencido')
