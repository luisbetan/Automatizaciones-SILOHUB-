...
import xmlrunner
import time
from Elements import click_checkbox_xpaht, find_and_click_element, find_and_click_element_selector, find_elements, validate_chain_text_xpaht, validate_character_numeric_element, validate_text_by_text, validate_text_visible
...
class detalle_ctro_entregaVentas(unittest.TestCase):
    ...
    def test_detail_deriverySales(self):
        ...
        select_files_pdf = "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-detail-contract/app-contract-detail-tabs/div/div[1]/app-deliveries-applied/app-deliveries-shared/app-header-for-responsive-table/div/div/div[2]/div/div[1]/app-download-button/div/ul/li[2]/a"
