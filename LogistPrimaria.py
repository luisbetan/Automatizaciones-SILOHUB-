...
class logistica_primarias(unittest.TestCase):
    ...
    def test_logistics_primaries(self):
        ...
        select_field = "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-logistics/div/div[2]/div[1]/app-reservation-request/div[2]/app-reservation-request-header/div/div/div[2]/div/div[1]/div[2]/select"
        option_field = "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-logistics/div/div[2]/div[1]/app-reservation-request/div[2]/app-reservation-request-header/div/div/div[2]/div/div[1]/div[2]/select/option[8]"
        select_option_click(self.driver, select_field, option_field )
        time.sleep(2)
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(logistica_primarias)
  runner = xmlrunner.XMLTestRunner(output='reportLogistPrimarias')
