...
import xmlrunner
import time
from Elements import  click_icon_delete,displace_element, find_and_click_element, find_elements, find_elements_css_selector, find_send_element, search_and_displace_account, select_option_click, validate_text
...
class precio_granos_fijaciones(unittest.TestCase):
    ...
    def test_price_fixings(self):
        ...
        option_grain = "/html/body/app-root/app-layout/app-vertical/div/div/div/div/app-market-main/app-grain-price/div[2]/app-grain-price-table[3]/div/div/table/tbody/tr[1]/td[2]/app-select/select/option[8]"
        ...
        select_arrow = "/html/body/div[4]/div[1]/span[2]"
        clicks = 1
        find_and_click_element(self.driver, select_arrow, clicks)

        insert_date1 = "/html/body/div[4]/div[2]/div/div[2]/div/span[18]"
        find_elements(self.driver, insert_date1)
        time.sleep(2)

        insert_date2 = "/html/body/div[4]/div[2]/div/div[2]/div/span[27]"
        ...
        select_accept_post = "/html/body/div[5]/div/div[6]/button[3]"
        ...
        find_elements_css_selector(self.driver, select_icon_hand)
        time.sleep(2)
        ...
        select_number_contract = "/html/body/ngb-modal-window/div/div/app-sales-intent-modal/div[2]/app-sales-intent-form/div/div[2]/div/div[2]/div/app-contract-searcher/ng-select/div/div/div[3]/input"
        option_number_contract = "/html/body/ngb-modal-window/div/div/app-sales-intent-modal/div[2]/app-sales-intent-form/div/div[2]/div/div[2]/div/app-contract-searcher/ng-select/ng-dropdown-panel/div/div[2]/div[2]"
