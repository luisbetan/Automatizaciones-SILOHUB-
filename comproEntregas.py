...
class comprobanteEntregas(unittest.TestCase):
    ...
    def test_vouchers_delivery(self):
       ...
       ## seleccionar filtro de entregas con rango de fecha 29/12/2023 al 26/01/2024
        ...
        select_delivery_filter1 = '/html/body/ngb-offcanvas-panel/div/ngx-simplebar/div[1]/div[2]/div/div/div/app-filter-content/div[2]/app-radio-button-list/div/app-radio[3]/div/input'
        find_elements(self.driver, select_delivery_filter1)
        time.sleep(2)
        ...
        contract_number1_expected = "TK 0001 00127175"
        ...
        contract_number2_expected = "TK 0001 00127180"
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(comprobanteEntregas)
  runner = xmlrunner.XMLTestRunner(output='reportComprobEntregas')
