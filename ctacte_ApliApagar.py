...
class cta_cte_apliApagar(unittest.TestCase):
    def setUp(self):
    ...
    def test_ctacte_apliApagar(self):
        ...
        apply_state = "/html/body/ngb-offcanvas-panel/div/ngx-simplebar/div[1]/div[2]/div/div/div/app-filter-content/div[2]/app-checklist/div/app-checks[2]/div/input" 
        ...
        number_movements = "Movimiento FC 1051 00014215"
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(cta_cte_apliApagar)
