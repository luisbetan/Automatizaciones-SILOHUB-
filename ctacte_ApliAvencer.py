...
class cta_cte_apliAvencer(unittest.TestCase):
    def setUp(self):
    ...
    def test_ctacte_apliAvencer(self):
        ...
        ## seleccionar rango de fecha 02-10-2023 a 01/12/2024
        ...
        select_date_2 = "/html/body/div/div[2]/div/div[2]/div/span[1]"
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(cta_cte_apliAvencer)
  runner = xmlrunner.XMLTestRunner(output='reportCtacteApliAvencer')
