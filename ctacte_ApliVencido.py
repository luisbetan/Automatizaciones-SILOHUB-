...
class cta_cte_apliVencido(unittest.TestCase):
    def setUp(self):
    ...
    def test_ctacte_aplivencido(self):
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(cta_cte_apliVencido)
  runner = xmlrunner.XMLTestRunner(output='reportCtacteApliVencido')
