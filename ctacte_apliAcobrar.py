...
class cta_cte_apliAcobrar(unittest.TestCase):
    def setUp(self):
...
if __name__ == "__main__":
  test_suite = unittest.TestLoader().loadTestsFromTestCase(cta_cte_apliAcobrar)
  runner = xmlrunner.XMLTestRunner(output='reportCtacteApliAcobrar')
